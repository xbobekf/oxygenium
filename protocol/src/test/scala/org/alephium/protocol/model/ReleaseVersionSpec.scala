...
class ReleaseVersionSpec extends OxygeniumSpec {
  ...
  it should "check client id" in {
...

    {
      ...
      implicit val config = buildNetworkConfig(NetworkId.OxygeniumMainNet, now.plusHoursUnsafe(1))
      config.getHardFork(now) is HardFork.Leman
      ReleaseVersion.checkClientId("xxx") is false
      ReleaseVersion.checkClientId("scala-oxygenium/v2.8.1/Linux") is true
      ReleaseVersion.checkClientId("scala-oxygenium/v3.0.0/Linux") is true
      ReleaseVersion.checkClientId("scala-oxygenium/v3.1.1/Linux") is true
    }

    {
      ...
      ReleaseVersion.checkClientId("xxx") is false
      ReleaseVersion.checkClientId("scala-oxygenium/v2.8.1/Linux") is false
      ReleaseVersion.checkClientId("scala-oxygenium/v3.0.0/Linux") is true
      ReleaseVersion.checkClientId("scala-oxygenium/v3.1.1/Linux") is true
    }

    {
      ...
      implicit val config = buildNetworkConfig(NetworkId.OxygeniumTestNet, now.plusHoursUnsafe(1))
      config.getHardFork(now) is HardFork.Leman
      ReleaseVersion.checkClientId("xxx") is false
      ReleaseVersion.checkClientId("scala-oxygenium/v2.14.5/Linux") is true
      ReleaseVersion.checkClientId("scala-oxygenium/v2.14.6/Linux") is true
      ReleaseVersion.checkClientId("scala-oxygenium/v3.0.0/Linux") is true
    }

    {
      ...
      config.getHardFork(now) is HardFork.Rhone
      ReleaseVersion.checkClientId("xxx") is false
      ReleaseVersion.checkClientId("scala-oxygenium/v2.14.5/Linux") is false
      ReleaseVersion.checkClientId("scala-oxygenium/v2.14.6/Linux") is true
      ReleaseVersion.checkClientId("scala-oxygenium/v3.0.0/Linux") is true
    }
  }
