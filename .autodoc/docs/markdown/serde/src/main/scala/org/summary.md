[View code on GitHub](https://github.com/oxygenium/oxygenium/.autodoc/docs/json/serde/src/main/scala/org)

The `org.oxygenium.serde` package in the Oxygenium project provides a serialization and deserialization library that is essential for data exchange and storage. It includes predefined serializers and deserializers for common data types and utility methods for composing and transforming them.
