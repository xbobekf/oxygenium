[View code on GitHub](https://github.com/oxygenium/oxygenium/.autodoc/docs/json/rpc/src)

The `.autodoc/docs/json/rpc/src` folder contains the implementation of the JSON-RPC 2.0 specification for the Oxygenium project. JSON-RPC is a remote procedure call (RPC) protocol encoded in JSON, providing a standardized way for clients to interact with the Oxygenium node.
