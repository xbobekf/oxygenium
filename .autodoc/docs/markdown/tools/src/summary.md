[View code on GitHub](https://github.com/oxygenium/oxygenium/.autodoc/docs/json/tools/src)

The `.autodoc/docs/json/tools/src` folder contains essential tools and utilities for the Oxygenium project, which are crucial for tasks such as generating documentation, calculating inflation rates, validating patches, and generating wallets. These tools help developers understand and work with the Oxygenium protocol more effectively.
