[View code on GitHub](https://github.com/oxygenium/oxygenium/.autodoc/docs/json/benchmark/src/main)

The `.autodoc/docs/json/benchmark/src/main` folder contains benchmarking tools for the Oxygenium project, which help developers measure the performance of different components and algorithms, identify bottlenecks, and optimize the codebase. The folder has a subfolder named `scala` that contains various Scala files for benchmarking purposes.
