[View code on GitHub](https://github.com/oxygenium/oxygenium/.autodoc/docs/json/wallet)

The `wallet` folder in the Oxygenium project is responsible for managing wallets, addresses, balances, and transactions. It provides a convenient and type-safe way for users to interact with their wallets and the Oxygenium blockchain.
