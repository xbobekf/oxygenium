...
The code in this folder is primarily focused on the implementation of the Oxygenium programming language, specifically the compiler, lexer, and static analysis components. It also includes code for managing scopes, types, and keywords in the language, as well as error handling and formatting.
