...
public class DiffMatchPatch {
    ...
    public int diff_commonPrefix(String text1, String text2) {
        ...
        int n = java.lang.Math.min(text1.length(), text2.length());
        for (int i = 0; i < n; i++) {
    ...
    public int diff_commonSuffix(String text1, String text2) {
        ...
        int text1_length = text1.length();
        int text2_length = text2.length();
        int n = java.lang.Math.min(text1_length, text2_length);
        for (int i = 1; i <= n; i++) {
    ...
    protected int diff_commonOverlap(String text1, String text2) {
        ...
        int text_length = java.lang.Math.min(text1_length, text2_length);
        ...
        while (thisDiff != null) {
            if (thisDiff.operation == Operation.EQUAL) {
                ...
                if (lastEquality != null && (lastEquality.length()
                        <= java.lang.Math.max(length_insertions1, length_deletions1))
                        && (lastEquality.length()
                        <= java.lang.Math.max(length_insertions2, length_deletions2))) {
        ...
        for (Diff aDiff : diffs) {
            switch (aDiff.operation) {
                ...
                case EQUAL:
                    ...
                    levenshtein += java.lang.Math.max(insertions, deletions);
                    insertions = 0;
                    deletions = 0;
                    break;
            }
    ...
    public int match_main(String text, String pattern, int loc) {
        ...
        loc = java.lang.Math.max(0, java.lang.Math.min(loc, text.length()));
    ...
    protected int match_bitap(String text, String pattern, int loc) {
        ...
        if (best_loc != -1) {
            score_threshold = java.lang.Math.min(match_bitapScore(0, best_loc, loc, pattern),
                    score_threshold);
        ...
        for (int d = 0; d < pattern.length(); d++) {
            ...
            bin_max = bin_mid;
            int start = java.lang.Math.max(1, loc - bin_mid + 1);
            int finish = java.lang.Math.min(loc + bin_mid, text.length()) + pattern.length();
                ...
                if ((rd[j] & matchmask) != 0) {
                    ...
                    if (score <= score_threshold) {
                        ...
                        if (best_loc > loc) {
                            ...
                            start = java.lang.Math.max(1, 2 * loc - best_loc);
                        } else {
    ...
    private double match_bitapScore(int e, int x, int loc, String pattern) {
        ...
        int proximity = java.lang.Math.abs(loc - x);
        if (Match_Distance == 0) {
    ...
    protected void patch_addContext(Patch patch, String text) {
        ...
        while (text.indexOf(pattern) != text.lastIndexOf(pattern)
            ...
            pattern = text.substring(java.lang.Math.max(0, patch.start2 - padding),
                    java.lang.Math.min(text.length(), patch.start2 + patch.length1 + padding));
        }
        // Add one chunk for good luck.
        padding += Patch_Margin;

        // Add the prefix.
        String prefix = text.substring(java.lang.Math.max(0, patch.start2 - padding),
                patch.start2);
        if (prefix.length() != 0) {
            ...
            if (start_loc == -1) {
                ...
                if (end_loc == -1) {
                    text2 = text.substring(start_loc,
                            java.lang.Math.min(start_loc + text1.length(), text.length()));
                } else {
                    text2 = text.substring(start_loc,
                            java.lang.Math.min(end_loc + this.Match_MaxBits, text.length()));
                }
                if (text1.equals(text2)) {
            ...
            while (!bigpatch.diffs.isEmpty()) {
                ...
                while (!bigpatch.diffs.isEmpty()
                    ...
                    if (diff_type == Operation.INSERT) {
                        ...
                        diff_text = diff_text.substring(0, java.lang.Math.min(diff_text.length(),
                ...
                precontext = precontext.substring(java.lang.Math.max(0, precontext.length()
                        - Patch_Margin));
